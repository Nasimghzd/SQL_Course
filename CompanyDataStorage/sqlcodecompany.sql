...
SELECT * FROM student
WHERE student_id > 2 AND major IN ('Biology', 'Chemistry');

-- creating complex company database
...
-- inserting information - corporate branch
...
-- Find alist of all money spent or earned by the company
